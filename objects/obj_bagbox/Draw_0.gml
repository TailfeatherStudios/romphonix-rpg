...
draw_rectangle_color(__view_get( e__VW.XView, 0 ) + 2,__view_get( e__VW.YView, 0 ) + 130,__view_get( e__VW.XView, 0 ) + 126,__view_get( e__VW.YView, 0 ) + 238,c_navy,c_navy,c_black,c_black,false)
draw_rectangle_color(__view_get( e__VW.XView, 0 ) + 6,__view_get( e__VW.YView, 0 ) + 134,__view_get( e__VW.XView, 0 ) + 122,__view_get( e__VW.YView, 0 ) + 234,c_black,c_black,c_navy,c_navy,false)
draw_rectangle(__view_get( e__VW.XView, 0 ) + 2,__view_get( e__VW.YView, 0 ) + 130,__view_get( e__VW.XView, 0 ) + 126,__view_get( e__VW.YView, 0 ) + 238,true)
...
repeat(17)
{
	...
	{
		draw_text(__view_get( e__VW.XView, 0 ) + 134,__view_get( e__VW.YView, 0 ) + 14*j,ds_grid_get(global.dsgrid_items,(pocket*2)-2,ds_grid_get(global.dsgrid_bag,(pocket*2)-2,i)))
		draw_text(__view_get( e__VW.XView, 0 ) + 300,__view_get( e__VW.YView, 0 ) + 14*j,":" + string(ds_grid_get(global.dsgrid_bag,(pocket*2)-1,i)))
	}
	i += 1
	j += 1
}
draw_text_ext(__view_get( e__VW.XView, 0 ) + 6,__view_get( e__VW.YView, 0 ) + 134,ds_grid_get(global.dsgrid_items,(pocket*2)-1,ds_grid_get(global.dsgrid_bag,(pocket*2)-2,selection+scroll)),14,128)
